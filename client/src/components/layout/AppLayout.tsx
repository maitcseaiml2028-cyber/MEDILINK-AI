        ...
        <div className="flex flex-col flex-1 min-w-0 overflow-hidden">
          ...
          <header className="sticky top-0 z-20 flex h-14 items-center gap-4 border-b border-slate-200/80 bg-white/90 backdrop-blur-xl px-5 shadow-sm">
            ...
            <div className="ml-auto flex items-center gap-2.5">
              ...
              <button 
                onClick={() => setProfileOpen(true)}
                className={`w-8 h-8 rounded-xl bg-gradient-to-br ${gradient} flex items-center justify-center text-white font-bold text-xs shadow-sm hover:scale-105 transition-all active:scale-95 cursor-pointer ring-offset-2 ring-blue-500/30 hover:ring-2`}
                title="My Profile"
              >
                {getInitials(user.name)}
              </button>
