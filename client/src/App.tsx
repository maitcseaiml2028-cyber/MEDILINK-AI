...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/hospital/patients" component={HospitalPatients} />
      <ProtectedRoute path="/hospital/check-out" component={HospitalCheckOut} />
      <ProtectedRoute path="/hospital/appointments" component={HospitalAppointments} />
      <ProtectedRoute path="/hospital/staff" component={HospitalStaff} />
      <ProtectedRoute path="/hospital/analytics" component={HospitalAnalytics} />
